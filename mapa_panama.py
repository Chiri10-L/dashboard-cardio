...
mapa_panama.py
===============
Código para el mapa interactivo de distritos de Panamá (Sección 5 del
notebook), en versión Plotly/Dash — para usar dentro de tu app.py.

Requiere los 2 archivos de datos que vienen junto a este script:
    data/panama_geo.json
    data/panama_ingresos.csv

No necesita geopandas en producción (ya viene todo pre-procesado).
"""
...
COLORS = {'muted': '#6c757d', 'card': '#ffffff'}
CARD_STYLE = {
...
# ---------- 3. LAYOUT (pestaña / sección para Dash) ----------
tab_mapa = html.Div([
    html.Div([
        html.H3("Ingreso Promedio por Distrito", style={'marginTop': 0}),
        html.P(
